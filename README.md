...
Seeking Full-Time Software Engineer roles starting January 2025. I partner with product and engineering teams to ship reliable backend services and automation that move business metrics - not just code
...
- Languages & frameworks: C#, .NET (Web API/ASP.NET MVC), Node.js/Express, TypeScript, React
- Data & storage: SQL Server, MongoDB, Redis
